...
if (isset($_GET['sid'])) {
    ...
    $query = "SELECT gebruikersnaam,naam,adres,email,wachtwoord,recht,puntenaantal,geslacht FROM  users where id = $sid";
            ...
            <section class="section-default">
                ...
                <form action="" method="post">
                    <table>
                        ...
                        <tr>
                            <td>Puntenaantal</td>
                            <td><input type="text" value="<?php echo $punten; ?>" required name="punten"></td>
                        </tr>
                        <tr>
                            <td>Toevoegen</td>
                            <td>
...
if (isset($_POST['aanpassen'])) {
    $query = "UPDATE users SET gebruikersnaam = '$gebnaam', adres = '$adres', email = '$email', wachtwoord = '$wachtwoord', recht = '$recht', puntenaantal = '$punten', geslacht = '$geslacht'WHERE id = $sid";
    $conn->query($query);
